...
public:
    ...
    void setupUi(QMainWindow *Client)
    {
        ...
        videoResult->setGeometry(QRect(170, 60, 201, 51));
        ...
        loadPictures->setGeometry(QRect(30, 30, 75, 23));
